...
<li class="single-menu">
	<a href="{{ route('admin.voitures.details', ['id' => 1]) }}" class="d-flex align-items-center justify-content-between">
		<div class="d-flex align-items-center">
			<i data-feather="alert-circle" stroke-width="1.5" height="18" class="me2"></i>
									...
									<div class="container-fluid">
										<div class="row g-0 align-items-center">
											<div class="col-lg-7 mb-sm-1">
												<div class="cover">
													<img src="{{asset('assets/auth/media/menu/1.jpg')}}" class="img-fluid w-100" alt="">
