...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('assets/auth/media/logo/car1.png') }}">
...
<body>
    ...
    <div class="app-root d-flex flex-column">
        ...
        <div class="app-sidebar">
            ...
            <div class="sidebar-logo d-flex justify-content-center">
                <a href="index.html">
                    <img src="{{ asset('assets/auth/media/logo/car2.png') }}" height="100" width="100"
                        alt="DomCarCenter">
                </a>
            </div>
            <!-- ***** Logo End ***** -->
                            ...
                            <div class="d-flex justify-content-start mb3 p5 pb0">
                                ...
                                <div class="d-flex flex-column text-start">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <span class="badge badge-soft rounded-pill text-bg-success">Admin</span>
                                    </div>
                                    <small>@DomCarCenter</small>
                                </div>
                            </div>
                            <!-- ***** Content Info End ***** -->
                ...
                <div class="container-fluid p0">
                    <div class="row">
                        <div class="col-sm-6 text-center text-lg-start mb-sm-1">
                            <span>2023©</span>
                            <span class="text-heading">DomCarCenter</span>
                        </div>
                        <div class="col-sm-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let updateButtons = document.querySelectorAll('button[data-bs-target="#updateCarModal"]');
            updateButtons.forEach(function(button) {
                button.addEventListener('click', function() {
                    // Récupérer l'ID de la voiture à partir de l'attribut de données
                    let carId = button.dataset.carId;
                    console.log(carId);
                    // Utilisez carId comme vous le souhaitez, par exemple, l'envoyer via une requête AJAX pour obtenir les détails de la voiture.
                });
            });
        });
    </script>
