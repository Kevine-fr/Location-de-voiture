        ...
        <div class="modal-content">
            <form method="post" action="{{ route('modeles.ajouter') }}" id="add-marque-form" novalidate="">
                ...
                <div class="modal-header px-4">
                    <h5 class="modal-title fs-5">Ajouter un model</h5>
                        ...
                        <div class="row mb5">
                            <div class="col-sm-12 mb5">
                                <label for="new-marque" class="form-label">
                                    <span>Nouveau Model</span>
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="nom" id="new-marque" class="form-control" required>
                                <div class="invalid-feedback">Veuillez entrer le nom du model.</div>
                                <label for="new-marque" class="form-label">
                                    <span>Marque</span>
                                    <span class="text-danger">*</span>
                                </label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Enregistrer le Model</button>
                </div>
            </form>
        </div>
    </div>
