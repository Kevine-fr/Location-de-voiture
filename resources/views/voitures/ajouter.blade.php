                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb5">
                                ...
                                <input type="date" name="annee" id="add-car-form-4" class="form-input" required>
                            ...
                            <div class="col-sm-6 mb5">
                                ...
                                <select name="statut" id="add-car-form-5" class="form-select js-choice" required="">
                        ...
                        <div class="row">
                            <label for="add-car-form-7" class="form-label">
                                ...
                                <span class="text-danger">*</span>
                                <i data-feather="info" stroke-width="2" height="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Write the price of the vehicle."></i>
                            </label>
                            <input name="prix" id="add-car-form-7" class="form-control" type="number" required="">
                            <div class="invalid-feedback">Veuillez remplir tous les champs.</div>
                        </div>
                        <div class="row">
                            <label for="add-car-form-7" class="form-label">
