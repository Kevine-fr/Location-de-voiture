        ...
        <div class="container p0">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form method="post" action="{{ route('marques.update',$marque) }}" id="add-marque-form" novalidate="">
                        @csrf
                        @method('PUT')
                        <div class="modal-header px-4">
                            <h5 class="modal-title fs-5">Modifier une marque</h5>
                            ...
                            <div class="container-fluid">
                                <div class="row mb5">
                                    <div class="col-sm-12 mb5">
                                        ...
                                        <input type="text" name="nom" id="new-marque" class="form-control" value="{{$marque->nom}}" required>
                                        <div class="invalid-feedback">Veuillez modifier le nom de votre marque.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
